...
#include "../../clientsAG-v.1.1/finddialog.h"
...
QT_MOC_LITERAL(3, 23, 8), // "openFind"
QT_MOC_LITERAL(4, 32, 16), // "parameterChanged"
QT_MOC_LITERAL(5, 49, 5), // "index"
QT_MOC_LITERAL(6, 55, 23), // "on_pushButtonOk_clicked"
QT_MOC_LITERAL(7, 79, 27) // "on_pushButtonCancel_clicked"

    },
    "FindDialog\0signalFind\0\0openFind\0"
    "parameterChanged\0index\0on_pushButtonOk_clicked\0"
...
void FindDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->signalFind((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 1: _t->openFind(); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&FindDialog::signalFind)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void FindDialog::signalFind(QString _t1)
{
