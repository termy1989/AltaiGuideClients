...
#include "../../clientsAG-v.1.1/connectdialog.h"
...
QT_MOC_LITERAL(1, 14, 11), // "signalLogin"
...
QT_MOC_LITERAL(5, 62, 27) // "on_pushButtonCancel_clicked"
    ...
    "ConnectDialog\0signalLogin\0\0openDialog\0"
...
void ConnectDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->signalLogin((*reinterpret_cast< QString(*)>(_a[1])),(*reinterpret_cast< QString(*)>(_a[2]))); break;
        ...
        {
            using _t = void (ConnectDialog::*)(QString , QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ConnectDialog::signalLogin)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void ConnectDialog::signalLogin(QString _t1, QString _t2)
{
